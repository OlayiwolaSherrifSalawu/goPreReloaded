# <a>GoPreLoaded</a>
## Understanding the fundamentals of go, here we "Go"
### Objectives
In this project I built a simple text completion/editing/auto-correction tool.

**Motivation**: my motivation is that I recently started my programing journey with learn2earn a company that uses 01 edu system and one of the task they was on go reloaded with taught me: modulelarization and majorly it taught me about string manipulation. 

### The Problem this project solves 

* The tool I built, will receive as arguments the name of a file containing a text that needs some modifications (the input) and the name of the file the modified text should be placed in (the output). Next is a list of possible modifications that your program should execute:
